  ...
  return (
    <div className="w-full">
      <div id="topNav" className="w-full">
        <div
          id="topNavLine1"
          className="w-full flex h-12 border-b border-foreground"
        >
        ...
        <div id="topNavLine2" className="flex h-4 border-b border-foreground">
          <div className="flex-none sm:w-12 w-8 border-r border-foreground" />
      ...
      <div id="horizontalDivs" className="flex">
        ...
        <div className="flex-none min-h-screen w-3 right-0 border-l border-foreground" />
        <div className="flex-none min-h-screen sm:w-12 w-8 right-0 border-l border-foreground" />
      </div>
    </div>
  )
}
