...
const HorizontalSection = ({ children }: { children: React.ReactNode }) => {
  return (
    <div className="flex flex-1 w-full overflow-hidden">
      ...
      <section className="flex-1 w-full p-8 m-1 overflow-hidden sm:max-lg:overflow-y-auto sm:scrollbar-thin sm:max-lg:scrollbar-thumb-primary-foreground scrollbar-track-background scrollbar-thumb-rounded-full scrollbar-track-rounded-full">
        {children}
      </section>
